    ...
    pub fn visit_doctor(&mut self, measurements: Measurements) -> HealthReport {
        ...
        let blood_pressure_change = match self.last_blood_pressure {
            ...
            Some((last_systolic, last_diastolic)) => {
                let systolic_change = measurements.blood_pressure.0 as i32 - last_systolic as i32;
                let diastolic_change = measurements.blood_pressure.1 as i32 - last_diastolic as i32;
